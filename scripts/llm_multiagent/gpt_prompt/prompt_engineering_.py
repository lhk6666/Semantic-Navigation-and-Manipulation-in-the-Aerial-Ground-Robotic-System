...
prompt_glo_pln = [
    {
        ...
        "content": (
            ...
            "When you arrange the cubes, I will tell you which cubs need to be arranged and which word need to be assembled. Please decide the sequence of the cubes in the word.\n\n"
            "For arranging tasks, you can set the first cube as the global point like (-5, 0) and then arrange other cubes based on the first cube (For example, the second cube can be placed at the right side of the first cube and the thrid cube can be arranged based on the second cube).\n\n"
